...
public class TokenValidator {
    ...
    public String generateToken(String username, String rol, int segundos) {
    	
        Date exp = getExpiration(new Date(), segundos);
        return Jwts.builder().setSubject(rol).setSubject(username).signWith(key).setExpiration(exp).compact();
    }
