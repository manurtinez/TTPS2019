			...
			switch (clase) {
				case "Desparasitacion": 
					eventoDTO = new EventoDTO(clase, e.getId(), e.getFecha(),
							((Desparasitacion) e).getDroga(), ((Desparasitacion) e).getResultado(), e.getMascotaID());
					resultado.add(eventoDTO);
					break;
				case "Enfermedad":
					eventoDTO = new EventoDTO(clase, e.getId(), e.getFecha(), ( (Enfermedad) e ).getDescripcion(), e.getMascotaID());
					resultado.add(eventoDTO);
					break;		
				case "HistorialReproductivo":
					eventoDTO = new EventoDTO(clase, e.getId(), e.getFecha(), ((HistorialReproductivo) e).getNroNacidos(), e.getMascotaID());
					resultado.add(eventoDTO);
					break;
				case "Intervencion":
					eventoDTO = new EventoDTO(clase, e.getId(), e.getFecha(), ((Intervencion)e).getDescripcion(), e.getMascotaID());
					resultado.add(eventoDTO);
					break;
				case "Vacunacion":
					eventoDTO = new EventoDTO(clase, e.getId(), e.getFecha(), ((Vacunacion)e).getDescripcion(), e.getMascotaID());
					resultado.add(eventoDTO);
					break;
				case "Visita":
					eventoDTO = new EventoDTO(clase, e.getId(), e.getFecha(), ((Visita) e).getDescripcion(),
							((Visita) e).getIndicaciones(), ((Visita) e).getMotivo(), ((Visita) e).getPeso(), e.getMascotaID());
					resultado.add(eventoDTO);
					break;
			}
		}
